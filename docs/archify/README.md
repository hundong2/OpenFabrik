# OpenFabrik Archify Architecture
...
- Repository URL: https://github.com/hundong2/OpenFabrik.git
- Checkout SHA: b83dc6000be90dc28e499cbf4f86b494b4091718
- README file: README_kor.md
- Evidence file: README_kor.md
- README title: 🏭 OpenFabrik
- Dependency markers: Python deps
- Top-level directories: docs, examples, guide, modules, pipelines, utilities
- Category: Agents and platforms

## 적용 프롬프트

~~~~text
Use Archify to create a high-level architecture diagram for OpenFabrik.
